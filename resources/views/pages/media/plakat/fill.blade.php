                                ...
                                <div class="mediaPlanningTable demo-x">
                                    ...
                                    <table class="table bigTable1780" style="    margin-bottom: 0px;">
                                        ...
                                        <tr class="tableHeadInline">
                                            <th style="width:16%;">PLATZIERUNG / GATTUNG</th>
                                            <th style="width:16%">STANDORTE</th>
                                            <th style="width:6.5%" class="text-truncate">Sprache</th>
                                            <th style="width:11.7%" class="text-truncate">format</th>
                                            <th style="width:8%; text-align: right" class="text-truncate">STELLEN / SCREENS</th>
                                            <th style="width:6.7%; text-align: right">KOSTEN BRUT/STELLE</th>
                                            ...
                                            <th style="width:6.4%; text-align: right">KOSTEN NET-<br> NET/STELLE</th>
                                        </tr>
                                        </thead>
                                            ...
                                            <tr>
                                                <td colspan="12" class="pdding-0">
                                                    <div class="collapsibleBar margin-0">
                                                        ...
                                                        @if ($table['note'] != "")
                                                            <div style="width:16.4%;position: relative;"><span class="note ic-triangle"><div class="note-data">{{$table['note']}}</div></span></div>
                                                        @endif
...
@section('page-js')
    <script type="text/javascript" src="{{asset('js/pages/media-planning-plakat.js')}}"></script>
@endsection
