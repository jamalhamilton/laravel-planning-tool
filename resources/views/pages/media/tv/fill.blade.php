                        ...
                        <div class="innerTabcontent">
                            <div class="whiteBgWrap row pdding-0">
                                <div class="mediaPlanningTable demo-x">
                                    ...
                                    <table class="table bigTable1780" style="min-width: 2000px;    margin-bottom: 0px;">
                                        <thead>
                                        <tr class="tableHeadInline">
                                            <th style="width:10%;">SENDER</th>
                                            <th style="width:9%">THEMA / PLATZIERUNG</th>
                                            <th style="width: 8%" class="text-truncate">Sprache</th>
                                            <th style="width:9%" class="text-truncate">DAUER / FORMAT</th>
                                            <th style="width: 8.5%; text-align: right" class="text-truncate">AUSSTRAHLUNGEN</th>
                                            <th style="width: 7.6%; text-align: right" class="text-truncate">Kontaktsumme</th>
                                            <th style="width:6.4%; text-align: right">GRP's</th>
                                            <th style="width:6.7%; text-align: right">SPOT BRUTTO IN CHF</th>
                                            <th style="width:6.4%; text-align: right">KOSTEN<br> BRUT</th>
                                            <th style="width:5.3%; text-align: right">rabatt in %</th>
                                            <th style="width:6.4%; text-align: right">KOSTEN<br> NET</th>
                                            <th style="width:5.3%; text-align: right">bk<br> in %</th>
                                            <th style="width:6.4%; text-align: right">KOSTEN<br> NET-NET</th>
                                            <th style="width:10.4%; text-align: right">SPOT N/N<br> in chf</th>
                                        </tr>
                                        </thead>
                                    ...
                                    @foreach ($data as $idx => $table)
                                        <table class="table bigTable1780" data-id="{{$table['id']}}" data-isconst="{{$table['isConstant']}}" style="min-width: 2000px">
                                            ...
                                            <tr>
                                                <td colspan="12" class="pdding-0">
                                                    <div class="collapsibleBar margin-0">
                                                        ...
                                                        @if ($table['note'] != "")
                                                            <div style="width:14%;position: relative;"><span class="note ic-triangle"><div class="note-data">{{$table['note']}}</div></span></div>
                                                        @endif
                                                            ...
                                                            <table class="table tableDisplay mytable" data-first="{{$table['media'][0]['id']}}">
                                                                ...
                                                                @foreach ($table['media'] as $idR => $media)
                                                                    <tr class="blankInputTd" data-id="{{$media['id']}}">
                                                                        ...
                                                                        <td data-type="free-input" class="{{(isset($media['mediaNotes']['4'])) ? 'cell-note':''}}" data-note="{{(isset($media['mediaNotes']['4'])) ? $media['mediaNotes']['4'] : ''}}">{!!$media['format']!!}</td>
                                                                        ...
                                                                        <td data-type="free-input" class="{{(isset($media['mediaNotes']['5'])) ? 'cell-note':''}}" data-note="{{(isset($media['mediaNotes']['5'])) ? $media['mediaNotes']['5'] : ''}}">{{$media['kontaktsumme']}}</td>
                                                                        <td data-type="free-input" class="{{(isset($media['mediaNotes']['6'])) ? 'cell-note':''}}" data-note="{{(isset($media['mediaNotes']['6'])) ? $media['mediaNotes']['6'] : ''}}">{{$media['grps']}}</td>
                                                                        <td data-type="free-input" class="{{(isset($media['mediaNotes']['7'])) ? 'cell-note':''}}" data-note="{{(isset($media['mediaNotes']['7'])) ? $media['mediaNotes']['7'] : ''}}">{{$media['tkpGrossCHF']}}</td>
                                                                        <td data-type="free-input" class="{{(isset($media['mediaNotes']['8'])) ? 'cell-note':''}}" data-note="{{(isset($media['mediaNotes']['8'])) ? $media['mediaNotes']['8'] : ''}}">{{$media['grossCHF']}}</td>
                                                                        <td data-type="free-input" class="{{(isset($media['mediaNotes']['9'])) ? 'cell-note':''}}" data-note="{{(isset($media['mediaNotes']['9'])) ? $media['mediaNotes']['9'] : ''}}">{{$media['discountPersentual']}}</td>
                                                                        <td data-type="free-input" class="{{(isset($media['mediaNotes']['10'])) ? 'cell-note':''}}" data-note="{{(isset($media['mediaNotes']['10'])) ? $media['mediaNotes']['10'] : ''}}">{{$media['netCHF']}}</td>
                                                                        <td data-type="free-input" class="{{(isset($media['mediaNotes']['11'])) ? 'cell-note':''}}" data-note="{{(isset($media['mediaNotes']['11'])) ? $media['mediaNotes']['11'] : ''}}">{{$media['bkPersentual']}}</td>
                                                                        <td data-type="free-input" class="{{(isset($media['mediaNotes']['12'])) ? 'cell-note':''}}" data-note="{{(isset($media['mediaNotes']['12'])) ? $media['mediaNotes']['12'] : ''}}">{{$media['nnCHF']}}</td>
                                                                        <td class="" data-type="free-input" class="{{(isset($media['mediaNotes']['13'])) ? 'cell-note':''}}" data-note="{{(isset($media['mediaNotes']['13'])) ? $media['mediaNotes']['13'] : ''}}">{{$media['tkpNNCHF']}}</td>
                                                                    </tr>
                                                                @endforeach
                                                                </tbody>
                                                            </table>
                                    ...
                                    <table class="table bigTable1780 tableDisplay tableDisplayField tableTotalMedia totalDisplayFooter totalMedia" style="min-width: 2000px;">
                                        <thead>
                                        <tr>
                                            <th style="width:10%"></th>
                                            <th style="width:9%"></th>
                                        ...
                                        <tr class="blankInputTd ">
                                            ...
                                            <td class = "alltotal grps disabled"></td>
...
@section('page-js')
    <script type="text/javascript" src="{{asset('js/pages/media-planning-tv.js')}}"></script>
@endsection
