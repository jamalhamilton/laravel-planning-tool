                                ...
                                <div class="mediaPlanningTable demo-x">
                                    ...
                                    <table class="table bigTable1780" style="    margin-bottom: 0px;">
                                        ...
                                        <tr class="tableHeadInline">
                                            <th style="width:16.6%;">PLATZIERUNG / REGIONEN</th>
                                            <th style="width:16.6%">KINO‘S / SÄLE</th>
                                            <th style="width:6.4%" class="text-truncate">Sprache</th>
                                            <th style="width:11.7%" class="text-truncate">DAUER / FORMAT</th>
                                            <th style="width:6.4%; text-align: right" class="text-truncate">KONTAKTE</th>
                                            <th style="width:6.7%; text-align: right">tkp brutto in chf</th>
                                            ...
                                            <th style="width:6.4%; text-align: right">tkp n/n<br> in chf</th>
                                        </tr>
                                        </thead>
...
@section('page-js')
    <script type="text/javascript" src="{{asset('js/pages/media-planning-kino.js')}}"></script>
@endsection
