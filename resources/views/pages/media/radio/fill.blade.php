                                ...
                                <div class="mediaPlanningTable demo-x">
                                    ...
                                    <table class="table bigTable1780" style="    margin-bottom: 0px;">
                                        ...
                                        <tr class="tableHeadInline">
                                            <th style="width:16.8%;">SENDER</th>
                                            <th style="width:16.8%">REGION / PLATZIERUNG</th>
                                            <th style="width:6.4%" class="text-truncate">Sprache</th>
                                            <th style="width:11.7%" class="text-truncate">DAUER / FORMAT</th>
                                            <th style="width:6.4%; text-align: right" class="text-truncate">SCHALTUNGEN</th>
                                            <th style="width:6.7%; text-align: right">SEKUNDEN-PREIS BRUTTO IN CHF</th>
                                            ...
                                            <th style="width:6.4%; text-align: right">SEKUNDEN-PREIS N/N<br> in chf</th>
                                        </tr>
                                        </thead>
...
@section('page-js')
    <script type="text/javascript" src="{{asset('js/pages/media-planning-radio.js')}}"></script>
@endsection
