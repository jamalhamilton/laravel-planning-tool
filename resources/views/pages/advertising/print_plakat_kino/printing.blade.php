        ...
        <div class=" border-redius-l-0">
            ...
            <div id="Online" class="tabcontent pdding-0">
                <div class="row">
                    ...
                    @php
                        $tableWidth = 353 + count($dateArray)*85;
                    @endphp
                        ...
                        <div class="whiteBgWrap row pdding-0">
                            <div class="mediaPlanningTable demo-x" style="padding-top: 15px;">
                                <table class="table" style='table-layout: fixed; width: {{$tableWidth}}px'>
                                    ...
                                    <tr class="right-text">
                                        @if($activetab == 'kino')
                                            <th width="230"  style="font-size : 12px;text-align: left !important;">PLATZIERUNG / REGIONEN</th>
                                            <th width="120"  style="font-size : 12px;">KONTAKTE</th>
                                        @elseif($activetab == 'plakat')
                                            <th width="230"  style="font-size : 12px;text-align: left !important;">PLATZIERUNG / GATTUNG</th>
                                            <th width="120"  style="font-size : 12px;">STELLEN / SCREENS</th>
                                        @elseif($activetab == 'print')
                                            <th width="230"  style="font-size : 12px;text-align: left !important;">TITEL</th>
                                            <th width="120"  style="font-size : 12px;">INSERATE</th>
                                        @endif
                                                ...
                                                <table class="table tableDisplay tableDisplayField tableAlignRight tableDisplayFieldPadding table-adv">
                                                    ...
                                                    <tr class="blankInputTd_adv" data-id={{$media['id']}}>
                                                        ...
                                                        @if ($media['adPrint'] != '0' && $media['adPrint'] != '' && $media['adPrint'] != 0)
                                                            ...
                                                            <td width="85" style="{{ ($count != ''?'background-color:#5cbe9b' : 'background-color:transparent')}}">
                                                                @if ($activetab != 'print')
                                                                    <input type="text" value="{{$count}}"  data-weeknum="{{$idx}}" style="text-align:center;color: #5cbe9b;">
                                                                @else
                                                                    <input type="text" value="{{$count}}"  data-weeknum="{{$idx}}" style="text-align:center;color: black;">
                                                                @endif
                                                            </td>
                                                            @endforeach
                                                        @endif
                                            ...
                                            <table class="table tableDisplay tableDisplayField totalDisplayFooter" style="width: auto">
                                                ...
                                                <tr class="blankInputTd_adv subtotaltr">
                                                    ...
                                                    @foreach($dateArray as $date)
                                                            <td width="85" style="font-size: 12px" class=""></td>
                                                    @endforeach
...
@section('page-js')
<script type="text/javascript" src="{{asset('js/pages/advertising-printing-print.js')}}"></script>
@endsection
