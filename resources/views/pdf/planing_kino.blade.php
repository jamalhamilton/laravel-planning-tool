    ...
    <div id="container">
        @if ($is_first == 1)
            <table class="t-title full100">
                <tr>
                    <td style="vertical-align: top"><h1 style="margin-top: -67px;"><img style="height: 130px;width: 130px;margin-top: 5px" src="{{ public_path() }}/icons/icon_kino.png" /> Kino
        ...
        <table class="tg" width="{{$autoTableWidth}}" style="width: {{$autoTableWidth}}px">
            ...
            <tr class="text-bold tr_highlight">
                ...
                <th width="120" class="nowrap tg-15li w120 text-right">TKP<br>BRUT CHF<br></th>
            ...
            @endphp
            <tr style="font-weight: bold !important;" class="tr_highlight">
