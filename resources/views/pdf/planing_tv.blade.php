    ...
    <div id="container">
        @if ($is_first == 1)
            <table class="t-title full100">
                <tr>
                    <td style="vertical-align: top"><h1 style="margin-top: -67px;"><img style="height: 130px;width: 130px;margin-top: 5px" src="{{ public_path() }}/icons/icon_tv.png" /> TV
        ...
        <table class="tg" width="{{$autoTableWidth}}" style="width: {{$autoTableWidth}}px">
            <tr class="text-bold">
                ...
                <th width="960" class="tg-1ans" colspan="10" >MEDIA- UND KOSTENPLANUNG</th>
            ...
            <tr class="text-bold tr_highlight">
                ...
                <th width="120" class="nowrap tg-15li w120 text-right">KONTAKT<br>SUMME</th>
                <th width="120" class="nowrap tg-15li w120 text-right">GRP's<br></th>
                <th width="120" class="nowrap tg-15li w120 text-right">SPOT BRUTTO<br>IN CHF<br></th>
                ...
                <th width="120" class="nowrap tg-15li w120 text-right">SPOT N/N<br>IN CHF</th>
                <th width="120" class="nowrap tg-15li w120 text-right">KOSTEN<br>NET-NET</th>
                <th width="30" class="nowrap tg-drrh w30" ></th>
                @for ($j = 0; $j < $size - 1; $j++)
                        ...
                        @for ($j = 0; $j < $size; $j++)
                            ...
                            @else
                                @if($hasExtra && ($_p == $_total_page -1))
                                    @if($x==0)
                                        <td class="tg-0lax tg-drrh bt_border2" rowspan="{{ count($media[$i]) }}" style="text-align:center;vertical-align: middle; width: 220px">{{trans('language.extraWeekMSG')}}</td>
                                    @endif
                                @else
                                    <td class="tg-0lax bt_border2 @if($j == $size - 1) @else br_border2 @endif text-right">
                                        @if($row[4] == 0 || $row[4] == '0' || $row[4] == 0.00 || $row[4] == '0.00' || $discount[$i][$x][$j+ ($_p*16)]=='tbd')
            ...
            <tr>
                <td colspan="14" style=" padding: 0!important;" height="<?php echo (50 + sizeof($rightTable)*30)?>">
