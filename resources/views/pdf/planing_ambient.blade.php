...
<div id="container">
    @if ($is_first == 1)
        <table class="t-title full100">
            <tr>
                <td style="vertical-align: top"><h1 style="margin-top: -67px;"><img style="height: 130px;width: 130px; margin-top: 5px;" src="{{ public_path() }}/icons/icon_ambient.png" /> Ambient
    ...
    <table class="tg" width="{{$autoTableWidth}}" style="width: {{$autoTableWidth}}px">
        ...
        <tr class="text-bold tr_highlight">
            ...
            <th width="120" class="nowrap tg-15li w120 text-right">TKP NET-<br>NET CHF</th>
    ...
    <!--  <table class="t-title">
            <tr>
                <td> </td>
                <td style="text-align: right;position: relative; height: 200px">
                    <br><br><br>
                    <img class="house-logo" style="position: absolute; top: -100px; right: 200px;" src="{{ public_path() }}/icons/amo-logo.png" />
                </td>
            </tr>
        </table>
        <div style="font-size: 50px">Seite {{$page_number}}/7</div> -->
