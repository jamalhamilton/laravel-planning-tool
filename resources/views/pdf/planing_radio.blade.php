...
@for($_p =0; $_p < $_total_page; $_p++)
    ...
    <div id="container">
        ...
        <table class="t-title full100">
            <tr>
                <td style="vertical-align: top"><h1 style="margin-top: -67px;"><img style="height: 130px;width: 130px;margin-top: 5px;" src="{{ public_path() }}/icons/icon_radio.png" /> Radio
        ...
        <table class="tg" width="{{$autoTableWidth}}" style="width: {{$autoTableWidth}}px">
            ...
            <tr class="text-bold tr_highlight">
                ...
                <th width="120" class="nowrap tg-15li w120 text-right">SCHALT<br>UNGEN</th>
