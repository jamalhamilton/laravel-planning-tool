    ...
    <div id="container">
        @if ($is_first == 1)
            <table class="t-title full100">
                <tr>
                    <td style="vertical-align: top"><h1 style="margin-top: -67px;"><img style="height: 130px;width: 130px;margin-top: 5px" src="{{ public_path() }}/icons/icon_print.png" /> Print
        ...
        <table class="tg" width="{{$autoTableWidth}}" style="width: {{$autoTableWidth}}px">
            <tr class="text-bold">
                ...
                <th width="960" class="tg-1ans  " colspan="6" >MEDIA- UND KOSTENPLANUNG</th>
            ...
            <tr class="text-bold tr_highlight">
                <th width="300" class="nowrap tg-15li w300">TITEL</th>
                ...
                <th width="120" class="nowrap tg-15li w120 text-right">INSERATE</th>
            ...
            @for ($i = 0; $i < sizeof($name); $i++)
                ...
                @foreach ($media[$i] as $row)
                    ...
                    <tr style="">
                        ...
                        @for ($j = 0; $j < $size; $j++)
                            ...
                            <td style="" class="tg-0lax bt_border2 @if($j == $size - 1)  @else br_border2 @endif text-right">
                ...
                <tr style="font-weight: bold !important;">
                    ...
                    <td class="tg-drrh" ></td>
                    @for ($j = 0; $j < $size; $j++)
                        <td style="font-weight: bold !important;" class="tg-15li @if($j == $size - 1)  @else  @endif text-right">
            ...
            <tr class="tr_highlight" style="font-weight: bold !important;">
                ...
                @for ($j = 0; $j < $size; $j++)
                    <td class="tg-16li bb_border @if($j == $size - 1)  @endif text-right" style="padding:10px;">
            ...
            <tr >
                ...
                <td colspan="6" style="margin-right: -20px !important;" >
